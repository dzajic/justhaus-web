...
**Subject:** Re: Cold-climate construction use case for the TELO MT1

Hi [Name],

I wanted to follow up on the Just Haus field-use concept I sent last week.

The concise version: we can put an MT1 into sustained residential construction work in northern New Hampshire, document winter and loaded-use performance, and observe charging alongside solar, stationary batteries, and off-grid constraints. I can provide technically informed feedback and case-study-ready documentation without assuming any unannounced vehicle capability.
